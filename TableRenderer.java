/**This code was not written by me, credits to
 ...
 * 
 * All this does is wrap the render around a CLI for convenience
  */
...
public class TableRenderer {
	...
	private String buildElement(String element, int width, String emptyChar) {
		...
		if (result.length() < width)
			...
			result += new String(new char[width - result.length()]).replace("\0",emptyChar);
		return result;
	}
